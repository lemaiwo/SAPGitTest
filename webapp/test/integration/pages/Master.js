				...
				assertions : {
					...
					theListHeaderDisplaysZeroHits : function () {
						return this.waitFor({
							viewName : sViewName,
							id : "page",
							matchers : new PropertyStrictEquals({name : "title", value : "FlightSet (0)"}),
							success : function () {
								Opa5.assert.ok(true, "The list header displays 'FlightSet (0)'");
							},
					...
					theListShouldBeSortedAscendingOnName : function () {
						return this.theListShouldBeSortedAscendingOnField("Connid");
					},
					...
					theListShouldHaveAllEntries : function () {
						...
						// retrieve all FlightSet to be able to check for the total amount
						...
						return this.waitFor({
							...
							success : function (oList) {
								...
								this.waitFor({
									id : "page",
									viewName : sViewName,
									matchers : new PropertyStrictEquals({name : "title", value : "FlightSet (" + iExpectedLength + ")"}),
									success : function () {
