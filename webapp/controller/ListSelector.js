sap.ui.define([
		...
		return BaseObject.extend("flexso.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias flexso.model.ListSelector
			 */
			 ...
			 * @return {flexso.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
